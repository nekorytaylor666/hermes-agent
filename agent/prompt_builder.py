...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines = [
        "# Nous Subscription",
        "Nous subscription includes managed web tools (Firecrawl), image/video generation (Higgsfield via higgsfieldcli), OpenAI TTS, and browser automation (Browser Use) by default. Modal execution is optional.",
        "Current capability status:",
    ]
    lines.extend(_status_line(feature) for feature in features.items())
    lines.extend(
        [
            "When a Nous-managed feature is active, do not ask the user for Firecrawl, Higgsfield, OpenAI TTS, or Browser-Use API keys.",
