...
# Video Skill — Seedance 2.0

Generate videos using `higgsfieldcli` and the seedance_2_0 model. This skill contains prompt engineering rules based on the CS3.5 production pipeline.
