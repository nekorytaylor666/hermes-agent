...
| Named characters per scene | ≤ 5 total |
| Prompt length | ≤ 4,000 characters |
| Parallel elements (single-shot) | ≤ 4 simultaneous actions/subjects |
...
### Dialogue
| Duration | Shots | Multi-shot Words | Single-shot Words | Max Exchanges |
|----------|-------|-----------------|-------------------|---------------|
| 5–6s | 2–3 | 12–16 | 6–8 | 2 |
| 7–8s | 3–4 | 15–20 | 8–12 | 3 |
| 9–10s | 3–5 | 20–25 | 12–16 | 4 |
| 11–12s | 4–6 | 25–30 | 16–22 | 4 |
| 13–15s | 5–7 | 30–35 | 22–28 | 5–6 |
...
Describe characters exactly as the user specifies, including any descriptors they provide. Use wardrobe + appearance + action. ≤ 5 named characters per scene, ≤ 3 per shot.

With reference images: describe by role, clothing, and action. Character sheets (multi-angle/neutral background) → extract character only, ignore sheet background as location.
